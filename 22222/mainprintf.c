...
int	main(int ac, char **av)
{
	...
	int pas = 0;
		...
		//	rl = printf("\033[0;31mREAL>\t[\n% 10.40d=\n% 10.40d=\n%+010.d=\n%10.0d=\n%+010.d=\n%10.0d=\n%+ 010.d=\n% 10.0d]\n", 0, -0, 0, -0, 0, 0, 0, 0);
			...
			me = ft_printf("\033[0;33mYOUR>\t[1\n//% 10.0d2\n//%4.5d3\n//%+#4.5d4\n//% 0-54.2d5\n//% 0-54.2d6\n//%- 0.2d7\n//%+-d8\n//% +-d9\n//%.4d10\n//%.4d11\n//%.d12\n//%.0d13\n//%d14\n//%hd15\n//%d16\n//%ld]\n", 0, 42, -42U, 2147483777LL, NULL - 1, NULL, 2147483647, -2147483648, 7, 12345, 1, 9, 126, 12356, 1456, -3456);
			//rl = printf("\033[0;31mREAL>\t[1//% 10.0d2//%4.5d3//%+#4.5d4//% 0-54.2d5//% 0-54.2d6//%- 0.2d7//%+-d8//% +-d9//%.4d10//%.4d11//%.d12//%.0d13//%d 14//%hd 15//%d 16//%ld]\n", 0, 42, -42U, 2147483777LL, NULL - 1, NULL, 2147483647, -2147483648, 7, 12345, 1, 9, 126, 12356, 1456, -3456);
				 rl = printf("\033[0;31mREAL>\t[\n1//% 10.0d\n2//%4.5d\n3//%+#4.5d\n4//% 0-54.2d\n5//% 0-54.2d\n6//%- 0.2d\n7//%+-d\n8//% +-d\n9//%.4d\n10//%.4d\n11//%.d\n12//%.0d\n13//%d\n14//%hd\n15//%d\n16//%ld]\n", 0, 42, -42U, 2147483777LL, NULL - 1, NULL, 2147483647, -2147483648, 7, 12345, 1, 9, 126, 12356, 1456, -3456);
			printf ("\033[0m%d/10: [%d] [%d]\n", no++, me, rl); (me == rl) ? printf("\033[1;32m✔︎ GOOD RETURN\033[0m\n") : printf("\033[1;31m✖︎ BAD RETURN\033[0m\n"); (me == rl) ? pas++ : 0;
...
printf ("%d/8: [%d] [%d]\n", no++, me, rl); (me == rl) ? printf("\033[1;32m✔︎ GOOD RETURN\033[0m\n") : printf("\033[1;31m✖︎ BAD RETURN\033[0m\n"); (me == rl) ? pas++ : 0;
			me = ft_printf("\033[0;33mYOUR>\t[42%#20.2o42][\\!/%#31o\\!/][42%#28.28o42][\\!/%#31o\\!/]\033[0m\n", 144491672, 0, 2147452292, 0);
			rl = printf("\033[0;31mREAL>\t[42%#20.2o42][\\!/%#31o\\!/][42%#28.28o42][\\!/%#31o\\!/]\033[0m\n", 144491672, 0, 2147452292, 0);
printf ("%d/8: [%d] [%d]\n", no++, me, rl); (me == rl) ? printf("\033[1;32m✔︎ GOOD RETURN\033[0m\n") : printf("\033[1;31m✖︎ BAD RETURN\033[0m\n"); (me == rl) ? pas++ : 0;
			me = ft_printf("\033[0;33mYOUR>\t[!%#24.8hho!][42%#42.10o42][>-<%#14.36o>-<][42%2.44o42]\033[0m\n", 2004675854, -140307224, 0, -0);
			rl = printf("\033[0;31mREAL>\t[!%#24.8hho!][42%#42.10o42][>-<%#14.36o>-<][42%2.44o42]\033[0m\n", 2004675854, -140307224, 0, -0);
printf ("%d/8: [%d] [%d]\n", no++, me, rl); (me == rl) ? printf("\033[1;32m✔︎ GOOD RETURN\033[0m\n") : printf("\033[1;31m✖︎ BAD RETURN\033[0m\n"); (me == rl) ? pas++ : 0;
