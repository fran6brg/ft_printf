...
/*   Updated: 2019/03/10 05:48:00 by fberger          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					helper_nb_padding(t_options *o, int l, int a, long long n);
int					helper_str_padding(t_options *opt, int ln, int aftr);
int					helper_floats_padding(t_options *option, int len, int after, int nb);
